import type { OrionProject } from '../types';

export const ORION_PROJECTS: OrionProject[] = [
  {
    id: 'orion',
    repoName: 'Orion',
    title: 'Orion',
    ...
    description: 'The entrypoint and map for Ben Haddons psychology and formation project universe.',
  ...
  },
  {
    ...
    subtitle: 'Archetypal Formation Through the Heros Journey',
    type: 'world',
    ...
    description: 'An interactive guide using Luke Skywalkers mythic journey as a framework for self-discovery and spiritual development.',
  ...
  },
  {
    ...
    description: 'An immersive ocean-themed web experience transforming Finding Nemos narrative structure into an interactive journey.',
...
export const getProjectById = (id: string) =>
  ORION_PROJECTS.find((project) => project.id === id);
